...
function Navbar() {
    ...
    const [kl,lk]=useState(false)
    useEffect(()=>{
        lk(state)
    },[state])
//    let[rasim,setRasim]=useState()
   let rasim=JSON.parse(localStorage.getItem("data"))
   console.log(kl)
   const ozgartirish=()=>{
...
useEffect(()=>{
  ...
  return (
    <div className='bg-orange-600'>
        <div className="navbar text-white  max-w-[1300px] div-1">
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <ul
        ...
        <li><NavLink to="/abaut">About</NavLink></li>
  ...
  <button className="btn btn-ghost btn-circle">
    ...
    {rasim&& <div className="dropdown dropdown-end">
